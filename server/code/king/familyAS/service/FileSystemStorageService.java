...
import king.familyAS.model.StorageProperties;

import king.familyAS.exception.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    public void store(MultipartFile file, String path) {
	    ...
	    Path fpath = null;
	    if(path != null){
		 fpath = Paths.get(this.location, path);
	    }else{
	         fpath = rootLocation;
	    }
